...
use crate::pokemon::domain::entities::PokemonNumber;
use crate::pokemon::repository::repository::{DeleteError, Repository};
...
mod tests {
    ...
    use crate::pokemon::domain::entities::{PokemonName, PokemonTypes};
