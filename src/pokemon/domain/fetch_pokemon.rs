...
use crate::pokemon::domain::entities::{Pokemon, PokemonNumber};
use crate::pokemon::repository::repository::{FetchOneError, Repository};
...
mod tests {
    ...
    use crate::pokemon::domain::entities::{PokemonName, PokemonNumber, PokemonTypes};
